export function projetosPage() {
    return `
        <h1 class="titulo-principal container">Nossos Projetos e Como Ajudar</h1>
        
        <section class="secao-projetos container">
            ...
            <article>
                ...
                <img src="/imagens/banner-projeto-acolher.png" width="2048" height="768" alt="Banner com o título 'Bem-vindo Projeto Acolher', em uma arte com diversos itens escolares, livros, lapis, cadernos, clipes, caneta e uma escola ao fundo.">
            </article>
            <article>
                <h3>Mãos na Horta</h3>
                <p>
                ...
                <img src="/imagens/banner-mao-na-horta.png" width="2048" height="768" alt="Banner com o título 'Mãos na horta', e desenho de 4 pessoas plantando sobre um campo.">
            </article>
        </section>
        
        <section class="secao-voluntario container">
            ...
            <a href="cadastro.html" class="cta-button">Quero ser voluntário!</a>
        </section>

        <section class="secao-doar container">
            <h2>Como Doar</h2>
            <p>
